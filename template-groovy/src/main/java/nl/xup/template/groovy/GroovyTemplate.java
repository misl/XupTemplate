...
/**
 * Template wrapper to turn a Groovy based template into a Template API
 * Template.
 * 
...
public final class GroovyTemplate extends AbstractTemplate {
  ...
  /**
   * Constructor to create a Template wrapper around a Groovy template instance.
   * 
   * @param engine
   *          the TemplateEngine that created this instance.
   * @param template
   *          the wrapped Groovy Template instance.
   */
  ...
  public String execute( Bindings bindings ) throws UnboundPropertyException {
    ...
    try {
      ...
      throw new UnboundPropertyException( ex.getProperty(), "Unboud property: " + ex.getProperty(),
          ex );
    }
