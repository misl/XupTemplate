...
public final class SimpleBindings implements Bindings {
	 ...
	 * @param merge The <code>Map</code> of values to add.
	 * @throws NullPointerException if merge is null
	 */
	...
	/**
	 * Check if the given key is a valid key. If not valid an exception will
	 * be thrown. A valid key should be a string with a value (not empty).
	 * 
