 ...
 * 
 * Through this interface it is possible execute template processing and to get
 * and set bindings to be used during execution. *
 * 
...
public interface Template {
  ...
  /**
   * <code>setBindings</code> stores the specified <code>Bindings</code>. These
   * bindings will be used when processing the template.
   * 
   * @param bindings
   *          The specified <code>Bindings</code>
   * @throws IllegalArgumentException
   *           when a null value is passed in.
   */
  void setBindings( Bindings bindings );

  /**
   * Processes the template and substitutes all properties/keys in the template
   * for the values of these keys in the bindings stored in this template.
   * 
  ...
  /**
   * Processes the template and substitutes all properties/keys in the template
   * for the values of these keys in the bindings store in this template and the
   * specified <code>Bindings</code>. The specified <code>Bindings</code> take
   * precedence over the stored ones.
   * 
   * @param bindings
   *          The specified <code>Bindings</code>
   * @return String containing the results of the processed template.
