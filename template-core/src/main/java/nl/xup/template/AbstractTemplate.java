...
public abstract class AbstractTemplate implements Template {
  ...
  /**
   * Allows for setting the Bindings to be used by the current template.
   * 
   * @param newBindings
   *          the new set of bindings.
   */
   ...
   * {@inheritDoc}
   */
  public abstract String execute() throws UnboundPropertyException, TemplateCompilationException;
