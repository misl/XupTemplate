...
/**
 * Template wrapper to turn a StringTemplate based template into a
...
public final class StringTemplate extends AbstractTemplate {
	...
	/**
	 * Constructor to create a Template wrapper around a StringTemplate 
	 * instance.
	 * 
	 * @param engine the TemplateEngine that created this instance.
	 * @param template the wrapped StringTemplate instance.
	 */
