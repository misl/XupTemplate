...
/**
 * Template wrapper to turn a Freemarker based template into a
...
public final class FreemarkerTemplate extends AbstractTemplate 
{
	...
	/**
	 * Constructor to create a Template wrapper around a Freemarker 
	 * based template instance.
	 * 
	 * @param engine the TemplateEngine that created this instance.
	 * @param template the wrapped Freemarker template instance.
	 */
	...
	public String execute(Bindings bindings) throws UnboundPropertyException, TemplateCompilationException 
	{
		...
		try {
			...
			throw new UnboundPropertyException( propertyName, "Unboud property: " 
					+ propertyName, e );
		} catch (Exception e) {
